...
- [Vue-Quick-Warfarin-V2](https://github.com/Napatchouli/Vue-Quick-Warfarin-V2) - Vue.js web app for clinicians to calculate Warfarin dosing, scheduling daily pills and totaling amounts for appointments. ![Language](https://img.shields.io/github/languages/top/Napatchouli/Vue-Quick-Warfarin-V2)
...
- [warfarin-app](https://github.com/pharmacist-sabot/warfarin-app) - A high-performance web-based regimen planner utilizing a unique hybrid architecture. It combines a reactive Vue.js frontend with a powerful calculation engine written in Rust and compiled to WebAssembly (WASM). This approach delivers near-native speed for generating and intelligently sorting numerous complex dosing schedules (including stop/special days) directly in the browser. ![Language](https://img.shields.io/github/languages/top/pharmacist-sabot/warfarin-app)
