...
- [Vue-Quick-Warfarin-V2](https://github.com/Napatchouli/Vue-Quick-Warfarin-V2) - Vue.js Warfarin Dosing App for Clinicians. ![Language](https://img.shields.io/github/languages/top/Napatchouli/Vue-Quick-Warfarin-V2)
- [warfarin6](https://github.com/penpharmacy/warfarin6) - PWA tool for pharmacists to verify daily pill regimens. Calculates total weekly dose and determines exact 2mg/3mg pill count for dispensing. ![Language](https://img.shields.io/github/languages/top/penpharmacy/warfarin6)
- [warfarin-app](https://github.com/pharmacist-sabot/warfarin-app) - A fast web-based regimen planner using Vue.js and Rust WebAssembly for intelligent dosing schedules. ![Language](https://img.shields.io/github/languages/top/pharmacist-sabot/warfarin-app)
...
- [Warfarin-Dose-Calculator](https://github.com/prajwal-17/warfarin-dose-calculator) - React + TypeScript app for anticoagulant dosing, supporting Warfarin (initiation & INR-based maintenance) and Acitrom. ![Language](https://img.shields.io/github/languages/top/prajwal-17/warfarin-dose-calculator)
...
- [warfarin-planner](https://github.com/warfarin-net/warfarin-planner) - Warfarin dose-to-pill PWA with smart, simple regimen sorting and dispensing calculations. ![Language](https://img.shields.io/github/languages/top/warfarin-net/warfarin-planner)
